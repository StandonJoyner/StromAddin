...
{
    public class SocketCoinFuturesStream : SocketStream
    {
        ...
        public SocketCoinFuturesStream(ILogger log)
        ...
        public void RegisterWindowHandler(string windowSize, Action<string, JToken> handler)
        {
